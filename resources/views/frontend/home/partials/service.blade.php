                ...
                <div class="services__item">
                    <div class="services__thumb">
                        <a href="services-details.html"><img
                                    src="{{ asset('theme/rasalina/img/images/services_img01.jpg') }}"
                                    alt=""></a>
                    </div>
                    <div class="services__content">
                        <div class="services__icon">
                            <img class="light"
                                 src="{{ asset('theme/rasalina/img/icons/services_light_icon01.png') }}" alt="">
                            <img class="dark" src="{{ asset('theme/rasalina/img/icons/services_icon01.png') }}"
                                 alt="">
                        </div>
