                ...
                <div class="col-xl-10 col-lg-12">
                    <ul class="nav nav-tabs portfolio__nav" id="portfolioTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active d-none" id="all-tab" data-bs-toggle="tab"
                                    data-bs-target="#all"
                                    type="button"
                        ...
                        {{--                    <li class="nav-item" role="presentation">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="branding-tab" data-bs-toggle="tab"
                                                        data-bs-target="#branding" type="button"
                        ...
                        <div class="col">
                            <div class="portfolio__active">
                                @foreach($projects as $category => $project)
                                    @if($project instanceof \App\Models\Backend\Portfolio\Project)
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ asset('theme/rasalina/img/portfolio/portfolio_img01.jpg') }}"
                                                     alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>{{ $category }}</span>
                                                <h4 class="title">
                                                    <a href="{{ route('frontend.projects.show', [$project->id, $project->slug]) }}">
                                                        {!! \App\Supports\Utility::textTruncate(($project->name ?? ''), 60) !!}
                                                    </a>
                                                </h4>
                                                <a href="{{ route('frontend.projects.show', [$project->id, $project->slug]) }}"
                            ...
                            <div class="row gx-0 justify-content-center">
                                <div class="col">
                                    <div class="portfolio__active">
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ asset('theme/rasalina/img/portfolio/portfolio_img07.jpg') }}"
                                                     alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ asset('theme/rasalina/img/portfolio/portfolio_img06.jpg') }}"
                                                     alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ asset('theme/rasalina/img/portfolio/portfolio_img02.jpg') }}"
                                                     alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ asset('theme/rasalina/img/portfolio/portfolio_img03.jpg') }}"
                                                     alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ asset('theme/rasalina/img/portfolio/portfolio_img04.jpg') }}"
                                                     alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{ asset('theme/rasalina/img/portfolio/portfolio_img05.jpg') }}"
                                                     alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
