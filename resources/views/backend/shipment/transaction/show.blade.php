...
@section('content')
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <p class="font-weight-bold">{{ $transaction->name ?? null }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="d-block">Enabled</label>
                                        <p class="font-weight-bold">{{ \App\Supports\Constant::ENABLED_OPTIONS[$transaction->enabled] }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <label class="d-block">Remarks</label>
                                        <p class="font-weight-bold">{{ $transaction->remarks ?? null }}</p>
                                    </div>
                                </div>
                            </div>
    ...
    {!! \App\Supports\CHTML::confirmModal('Transaction', ['delete', 'restore']) !!}
@endsection
