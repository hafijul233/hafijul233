...
@section('actions')
    {!! \Html::backButton('backend.settings.contacts.index') !!}
    {!! \Html::modelDropdown('backend.settings.contacts', $contact->id, ['color' => 'success',
...
@section('content')
    ...
    {!! \App\Supports\CHTML::confirmModal('Contact', ['delete', 'restore']) !!}
@endsection
