...
<div class="card-body">
    ...
    true, 3, ['placeholder' => __("enumerator.Select a Survey Option")]) !!}
        ...
        old('prev_post_state_id', $enumerator->previousPostings->pluck('id')->toArray() ?? null), false, 3) !!}
        ...
        old('future_post_state_id', $enumerator->futurePostings->pluck('id')->toArray() ?? null), false, 3) !!}
